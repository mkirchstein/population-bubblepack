...
function drawAll() {
	...
	var data,
	 ...
	 d3.csv("data/population by age.csv", function(error, csv) {
		 csv.forEach(function(d) {
      console.log('>>>> population by age - d', d);
			d.value = +d.value;
		 });
	...
	d3.json("data/population.json", function(error, dataset) {
		...
		//////////////////////////////////////////////////////////////
		/////////// Create a wrappers for each segment ///////////////
		//////////////////////////////////////////////////////////////
...
function searchEvent(segment) {
	//If the segment is not equal to the default - mouseover function
	if (segment !== "" & typeof segment !== "undefined") {
		d3.selectAll("#nodeCircle")
			.filter(function(d,i) { return d.name === segment; })
...
function zoomTo(d) {
    ...
    console.log('>>>> IDbyName[d.name]', IDbyName[d.name]);
